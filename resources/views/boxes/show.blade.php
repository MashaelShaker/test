    ...
    <style>
        ...
        * {
        ...
        .package-header {
            ...
            /* Aligns title to the right and price to the left */
        ...
        .product-option-card.selected {
            ...
            box-shadow: 0 4px 15px rgba(98, 208, 182, 0.2);
        ...
        .btn-back:hover {
            background: #555;
            /* Changes to teal on hover as requested */
            color: white;
            border-color: #555;
            text-decoration: none !important;
        }
...
@section('content')
                        ...
                        <div class="products-scroll-wrapper">
                            @foreach ($element->products as $product)
                                <div class="product-option-card"
                                    onclick="selectProduct(this, 'element-{{ $element->id }}')"
    ...
    <script>
        function selectProduct(cardElement, elementGroupId) {
            const wrapper = cardElement.closest('.products-scroll-wrapper');
            wrapper.querySelectorAll('.product-option-card').forEach(card => {
                card.classList.remove('selected');
            });
            cardElement.classList.add('selected');
            console.log(`Selected product ${cardElement.dataset.productId} for ${elementGroupId}`);
        }
    </script>
@endsection
